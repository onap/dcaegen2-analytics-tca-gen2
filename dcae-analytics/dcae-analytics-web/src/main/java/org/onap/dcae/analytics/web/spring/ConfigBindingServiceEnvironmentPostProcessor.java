...
public class ConfigBindingServiceEnvironmentPostProcessor implements EnvironmentPostProcessor, Ordered {
    ...
    private synchronized void addJsonPropertySource(final ConfigurableEnvironment environment, final PropertySource<?> source) {
    ...
    *
    */
   private String parseTcaConfig(JsonObject jsonObject) {
